...
class CF7GSC_googlesheet {
   ...
   const clientId = '537975197823-pb2q2djlo5915appk5d000u0km677ohc.apps.googleusercontent.com';
   const clientSecret = '5RvwKOR-QT23Z3XUO7cwOaRB';
   ...
   public static function updateToken( $tokenData ) {
      ...
      try {
         ...
         update_option( 'cf7glgsheet_token', $tokenJson );
      } catch ( Exception $e ) {
   ...
   public function auth(){
      $tokenData = json_decode( get_option( 'cf7glgsheet_token' ), true );
